...
const OTPverify = () => {
    ...
    const reSentOtp = () => {
        axios.post(`${base_URL}/api/reSentotp`, {
            email
        }).then(response => {
    ...
    const verifyOTP = () => {
        axios.post(`${base_URL}/api/verify`, {
            email,
            OTP: otp
        }).then(response => {
            ...
            .catch(error => {
                ...
                else if (error.response.data.message == '"OTP" is not allowed to be empty') {
                    setAlertShow(true);
                    setSuccessAkert(false)
                    setAlertText("OTP is not Empty")
                } 
                else {
                    setAlertShow(false);
                }
